...
public record GetExcelSteps(HttpProvider httpProvider, ScenarioContext scenarioContext, WorkbookUtil excelService) {
    ...
    public void verifyExcelResponse(String file) {
        ...
        try (var expectedResult = excelService.loadExcelFromResources("expected_results/{0}.xlsx",
            file)) {
            ...
            throw new RuntimeException("Error when comparing with expected spreadsheet", e);
        }
