Feature: Get Single Report
  ...
  Scenario: Should return report that exists
    When it calls the get reports endpoint with id "c16eb360-6f61-4588-882e-a9528429e82e"
  ...
  Scenario: Should return unrecognised id error for unknown id
    When it calls the get reports endpoint with id "01010101-0101-0101-0101-010101010101"
